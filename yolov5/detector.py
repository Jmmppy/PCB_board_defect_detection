...
class Detector(object):
    ...
    Return:
        result, image: 检测信息[x1, y1, x2, y2], 图片
    '''

    def __init__(self, conf_thres=0.45,
                 iou_thres=0,
                 classes=None,
                 imgsz=252,
                 weights="/home/zhy/yolov5-6.0/yolov5-6.0/yolov5s.pt"):
    ...
    def letterbox(self, img, new_shape=(252, 252), color=(114, 114, 114), auto=True, scaleFill=False, scaleup=True,
                  stride=32):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for c in det[:, -1].unique():
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    self.plot_one_box(xyxy, image, label=label, color=colors[int(cls)], line_thickness=1)
